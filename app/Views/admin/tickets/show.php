...
<div>
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form>
                <div class="card-text">
                    <a href="<?= base_url('admin/tickets/enviarEmail') ?>">Enviar email</a>
                </div>    
            </form>


            <div>
                <a href="https://api.whatsapp.com/send?phone=522312066656">Enviar whats</a>
            </div>


            <div>
                <a target="_blank" aria-label="Chat on WhatsApp" href="https://wa.me/52<?= esc($ticket['phone']); ?>"> <img alt="Chat on WhatsApp" src="WhatsAppButtonGreenLarge.svg" />
            </div>
